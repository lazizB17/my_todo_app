...
import '../views/due_date_element_view.dart';
...
class TaskDetailScreen extends StatefulWidget {
  ...
  const TaskDetailScreen({Key? key, this.toDo, this.state = DetailState.read})
      : super(key: key);
...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  void _getTodo() {
    _toDo = widget.toDo!;
    title = _toDo.category
        .toString()
        .substring(_toDo.category.toString().lastIndexOf("/") + 1);
                ...
                children: [
                  ...
                  DueDateElement(
                    onTap: () {
                      DateTime now = DateTime.now();
                      _toDo.dueDate =
                          DateTime(now.year, now.month, now.day + 7, now.hour)
                              .toString();
                    },
                    title: "Next Week",
                  ),
  ...
  void _pickADate() {
    ...
    showDatePicker(
      context: context,
      initialDate: _toDo.dueDate != null
          ? DateTime.parse(_toDo.dueDate!)
          : DateTime.now(),
  ...
  void _changeCompleted(bool? value) {
    ...
    if (value) {
      ...
      taskTime =
          'Created on ${_weekName(DateTime.now().weekday)}, ${DateTime.now().day} ${_monthName(DateTime.now().month)}';
    }
    setState(() {});
  }
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () =>
                                      _addOrRemoveToDoInImportant(_toDo),
                                  icon: _toDo.isImportant
